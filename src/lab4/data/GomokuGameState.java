...
public class GomokuGameState extends Observable implements Observer {
	...
	public GomokuGameState(GomokuClient gc) {
		client = gc;
		client.addObserver(this); //Konstruktor som sätter vår gridsize till vår DEFAULT_SIZE.
	 ...
	 */
	public String getMessageString() {		//Retunerar message som är en string.
		return message; 					
	}
	 ...
	 */
	public GameGrid getGameGrid() {		//En getter som  gör att man kan hämta GameGrid.
		return gameGrid;
	}
	...
	public void move(int x, int y) {
		if (currentState == MY_TURN) {
			boolean temp = gameGrid.move(x, y, GameGrid.ME);
